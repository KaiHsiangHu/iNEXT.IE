---
title: "A Quick Introduction to iNEXT.IE via Examples"
author: "Kai-Hsiang Hu and Anne Chao"
date: "`r Sys.Date()`"
output:
  rmarkdown::html_vignette:
    vignette: >
      %\VignetteIndexEntry{A Quick Introduction to iNEXT.IE via Examples}
...
```{r eval=FALSE}
## install the iNEXT.IE package from CRAN
...
<td align="left">a numerical vector specifying the diversity orders. Default is <code>c(0.5, 1, 2)</code>.</td>
</tr>
<tr class="even">
...
If <code>NULL</code>, then <code>endpoint</code> <code>=</code> the maximum sample sizes, which is set to double the reference sample size when rho is less than 0.2; triple the reference sample size when rho is between 0.2 and 0.4; and the total number of individuals when rho exceeds 0.4.</td>
</tr>
<tr class="even">
